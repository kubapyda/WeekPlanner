...
export class RepeatableComponent implements OnInit {
  ...
  actions: Array<{ name: string, weekDays: Array<{ name: string, timeFrom: string, timeTo: string }> }> = [];
  action: { name: string, weekDays: Array<{ name: string, timeFrom: string, timeTo: string }> } = {
    name: '',
    weekDays: []
  };
